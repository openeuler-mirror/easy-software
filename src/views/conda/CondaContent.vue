...
const pkgData = ref([]);
const PAGE_ID = 'CONDA';
const tabName = ref(PACKAGE_TYPE_MAPPING['conda']);
...
const pageSearch = () => {
  ...
  if (tabName.value === PACKAGE_TYPE_MAPPING['conda']) {
...
// 获取路由参数
const { routeKey, routeName, routeType, routeOs, routeArch, routeCategory } = useRouteQuery(PACKAGE_TYPE_MAPPING['conda']);
